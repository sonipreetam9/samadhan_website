            ...
            <div class="col-xl-4 mb-4">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="row text-start">
                            <div class="col-12 col-md-6 mb-2">
                                <p><strong>नाम:</strong> {{ $list->candidate_name }}</p>
                                <p><strong>पिता का नाम:</strong> {{ $list->father_name }}</p>
                                <p><strong>जन्मतिथि:</strong> {{ $list->dob_day }}/{{ $list->dob_month }}/{{
                                    $list->dob_year }}</p>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                ...
                                <p><strong>पिनकोड:</strong> {{ $list->pincode }}</p>
                                <p><strong>शुल्क (Fees):</strong> ₹{{ $list->fees }}</p>
                    ...
                    <div class="card-footer d-flex justify-content-end gap-2">
                        <a href="{{ route('super.update.payment.status', ['id' => $list->id, 'status' => 'failed']) }}"
                            onclick="return confirm('क्या आप वाकई इसे अस्वीकृत करना चाहते हैं?')"
                            class="btn btn-danger btn-sm">
                            <i class="ri-close-line"></i> Failed
                        </a>

                        <a href="{{ route('super.update.payment.status', ['id' => $list->id, 'status' => 'completed']) }}"
